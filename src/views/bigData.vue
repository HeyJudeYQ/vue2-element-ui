    ...
    <my-tabs v-model="activeName">
      <my-tab-content label="定时器和请求动画帧" name="aaa">
        <div v-if="activeName == 'aaa'">
          <el-button style="margin-bottom: 12px" size="small" type="primary" :loading="loading"
            @click="plan">点击请求加载</el-button>
          <el-table height="300" :data="arr" border style="width: 80%" :header-cell-style="{
            height: '24px',
            lineHeight: '24px',
            color: '#606266',
            background: '#F5F5F5',
      ...
      <my-tab-content label="vue-virtual-scroller" name="eee">
...
import VTable from '../otherComponents/VueVirtualScroller';
export default {
  name: "bigDataName",
  components: {
    bottomLoad,
